/** Inline SVG loading indicator for the translation region (shadow-DOM safe). */
export const TRANSLATION_RIPPLE_HTML = `<svg class="translation-ripple" viewBox="0 0 44 44" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  <title>Loading...</title>
