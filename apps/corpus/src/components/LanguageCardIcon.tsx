type LanguageCardIconProps = {
  className?: string;
};

export const LANGUAGE_CARD_ICON_PATH =
...
export function LanguageCardIcon({ className = 'size-5 shrink-0' }: LanguageCardIconProps) {
  return (
    <svg
