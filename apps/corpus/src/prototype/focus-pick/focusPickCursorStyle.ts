export type FocusPickChipTheme = 'dark' | 'light';

export type FocusPickCursorClasses = {
  chip: string;
  chipActive: string;
  action: string;
};

/** Cursor-style chip / toolbar — soft fills, light gray borders. */
export function focusPickCursorClasses(
  theme: FocusPickChipTheme,
