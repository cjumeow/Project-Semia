...
Master languages through seamless immersion and semantic understanding.

## Releases

 [All releases](https://github.com/cjumeow/Project-Semia/releases)
...
| [v0.4.1](https://github.com/cjumeow/Project-Semia/releases/tag/v0.4.1) | 2026-07-29   | AI loading UI, My Notes markdown, auto-generate on capture                               |
| [v0.4.0](https://github.com/cjumeow/Project-Semia/releases/tag/v0.4.0) | 2026-07-29   | SEMIA library UI, real capture sync, AI snippet notes (DeepSeek/OpenAI)                  |
...
Install: download `semia-extension-v0.5.2.zip` from the release page (not Source code).
